        ...
        <Box sx={{ mb: 3 }}>
          <Alert severity="error" sx={{ mb: 3 }}>
            ...
            <Typography variant="body2">
              Se eliminarán permanentemente todos los diagramas, comentarios y
              datos del proyecto.
            </Typography>
          </Alert>
          ...
          >
            ...
            <Box sx={{ display: "flex", gap: 2, mt: 1 }}>
              <Typography variant="caption" color="text.secondary">
                {project.diagrams_count} diagrama
                {project.diagrams_count !== 1 ? "s" : ""}
              </Typography>
              <Typography variant="caption" color="text.secondary">
                {project.collaborators_count} colaborador
                {project.collaborators_count !== 1 ? "es" : ""}
              </Typography>
            </Box>
          </Box>
