...
import { type Project, type ProjectCreate } from "../../types";
    ...
    >
      <DialogTitle>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
          Crea un proyecto para organizar tus diagramas UML y colaborar con
          otros
        </Typography>
      </DialogTitle>
      ...
      <DialogContent dividers>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <Alert severity="info" sx={{ mt: 1 }}>
            <Typography variant="body2">
              💡 <strong>Consejo:</strong> Puedes agregar colaboradores y crear
              diagramas después de crear el proyecto.
            </Typography>
          </Alert>
        </Box>
      </DialogContent>
